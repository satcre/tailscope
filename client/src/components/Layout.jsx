        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-8">
          <Link to="/" className="flex items-center gap-1.5">
            <svg viewBox="0 0 440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-16" style={{ width: 'auto' }}>
              ...
              <text x="84" y="72" fontFamily="system-ui, -apple-system, sans-serif" fontSize="48" fontWeight="800" fill="currentColor" letterSpacing="-1">tail<tspan fill="#EF4444" fontFamily="'Caveat', cursive" fontSize="54" fontWeight="700" dy="2">scope</tspan></text>
              <path d="M78 60 Q88 54 98 60 Q108 66 118 60 Q128 54 138 60 Q148 66 158 60" stroke="#EF4444" strokeWidth="4" fill="none" strokeLinecap="round"/>
            </svg>
          </Link>
