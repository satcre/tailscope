        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center gap-8">
          <Link to="/" className="flex items-center gap-1.5">
            <svg viewBox="0 0 440 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-16" style={{ width: 'auto' }}>
              ...
              <path d="M78 60 Q88 48 98 60 Q108 72 118 60 Q128 48 138 60 Q148 72 158 60 Q168 48 178 60 Q188 72 198 60" stroke="#EF4444" strokeWidth="4" fill="none" strokeLinecap="round"/>
            </svg>
          </Link>
